				...
				if (rsFormCaptcha === true) {
					...
					$.post( rsFormAction,
						...
						function (response) {
							...
							if(data){								
								rsForm.append('<div class="rsFormResponce"><strong>Parabéns!</strong><br>Seu e-mail foi enviado com sucesso!</div>');
							} else {
								rsForm.append('<div class="rsFormResponce"><strong>OOPS!</strong> Algo deu errado.<br>Por favor, tente novamente.</div>');
							}							
						}
					);
					return false;
